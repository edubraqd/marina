			...
			<div class="container">									
				<div class="row">											
					<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="ab_img">
							<img src="assets/img/about4.png" class="img-fluid" alt="image">
						</div>
					</div><!--- END COL -->						
    ...
    <div class="row text-center">
      <div class="col-lg-3 col-sm-6 col-xs-12 no-padding">
        <div class="single-project">
          ...
          <h4>Transformações acompanhadas</h4>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 col-xs-12 no-padding">
        <div class="single-project">
      ...
      <div class="col-lg-3 col-sm-6 col-xs-12 no-padding">
        <div class="single-project">
          ...
          <h4>Conteúdos e receitas disponíveis</h4>
        </div>
      </div><!-- END COL -->
      <div class="col-lg-3 col-sm-6 col-xs-12 no-padding">
        <div class="single-project">
          <h2 class="counter-num">541</h2>
          <h4>Planos personalizados entregues</h4>
        </div>
      </div><!-- END COL -->
    </div><!--- END ROW -->
  </div><!--- END CONTAINER -->
