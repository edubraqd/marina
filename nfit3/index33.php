...
<?php include './partials/head.php'?>
    ...
    <body data-spy="scroll" data-offset="80">
		...
		<?php include './partials/banner-two.php'?>	
			...
			<div class="container">									
				<div class="row">												
					<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						...
						<div class="skill_btn">
							<a href="services.php" class="btn_one">Get your services <i class="ti-arrow-top-right"></i></a>			
							<a href="contact.php" class="btn_two">Contact with us <i class="ti-arrow-top-right"></i></a>
						</div>						
					</div><!--- END COL -->	
		...
		<section class="service_area section-padding">
			<div class="container">	
				<div class="row">
					...
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="ser_btn">
							<a href="services.php" class="btn_two">View all services <i class="ti-arrow-top-right"></i></a>
						</div>
					</div>
				</div>
				<div class="row">								
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_service">
							...
							<a href="service_details.php">Read More <i class="ti-arrow-top-right"></i></a>
						</div>
					</div><!--- END COL -->						
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_service">
				...
				<div class="row">								
					<div class="col-lg-3 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_port">
							...
							<a href="project_details.php">View Details <i class="ti-arrow-top-right"></i></a>
						</div>
					</div><!--- END COL -->					
				...
				<div class="row">													
					<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="section-title">
							...
							<a href="team.php" class="btn_one">View all members <i class="ti-arrow-top-right"></i></a>
						</div>					
					</div><!--- END COL -->					
					<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">	
						<div class="row">								
				...
				<div class="row">								
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_blog">
							...
							<span><a href="single_blog.php">Security</a></span>	
							<span>February 15, 2025</span>	
							<h3><a href="blog.php">How can you improvement to your business policy for the better product.</a></h3>
							<a href="blog.php" class="blog_btn">View Details <i class="ti-arrow-top-right"></i></a>
						</div>
					</div><!--- END COL -->						
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_blog">
							...
							<span><a href="single_blog.php">Security</a></span>	
							<span>February 15, 2025</span>	
							<h3><a href="blog.php">people poputation change anything what your need for your next generation.</a></h3>
							<a href="blog.php" class="blog_btn">View Details <i class="ti-arrow-top-right"></i></a>
						</div>
					</div><!--- END COL -->						
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_blog">
							...
							<span><a href="single_blog.php">Security</a></span>	
							<span>February 15, 2025</span>	
							<h3><a href="blog.php">Improve your business so that you can stay in your local business in next month.</a></h3>
							<a href="blog.php" class="blog_btn">View Details <i class="ti-arrow-top-right"></i></a>
						</div>
					</div><!--- END COL -->												  
				</div><!--- END ROW -->
